package io.questdb.beam.examples.game.injector;
...
/**
 * This is a generator that simulates usage data from a mobile game, and writes it to a file.
 *
 * It was adapted from the Apache Beam example code at https://raw.githubusercontent.com/apache/beam/master/examples/java/src/main/java/org/apache/beam/examples/complete/game/injector/Injector.java
 *
 ...
 *
 * <p>The Injector takes the following arguments: {@code Injector filename}.
 *
 */
/**
 *  @SuppressWarnings({
...
public class Injector {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        if (args.length < 1) {
            System.out.println("Usage: Injector filename");
            System.exit(1);
        }
